package br.com.fnascimento.demomqttandroid
...
class MainActivity : AppCompatActivity() {
    ...
    private val topicoLED = "led_status_fernando"
    private val topicoAppLED = "led_status_app_fernando"
    ...
    fun subscribeLed() {
        val qos = 1
        try {
            val subToken = client.subscribe(topicoAppLED, qos)
    ...
    private fun unsubscribeLed() {
        ...
        try {
            val unsubToken = client.unsubscribe(topicoAppLED)
